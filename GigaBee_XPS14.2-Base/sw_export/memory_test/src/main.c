...
volatile u32 *mcb3_ddr3_mem = (u32*)XPAR_MCB3_DDR3_S0_AXI_BASEADDR;
...
int main()
{
	...
	u32 test_size = (XPAR_MCB1_DDR3_S0_AXI_HIGHADDR - XPAR_MCB1_DDR3_S0_AXI_BASEADDR)/sizeof(u32);
//	u32 test_size = 10000;
	u32 error = 0;
    ...
    xil_printf("==========================================================\n\r");
    xil_printf("Base Address : 0x%04X\r\n",XPAR_MCB3_DDR3_S0_AXI_BASEADDR);
    xil_printf("High Address : 0x%04X\r\n\r\n",XPAR_MCB3_DDR3_S0_AXI_HIGHADDR);
    //-------------------------------------------------------------------------
