...
Peripheral Summary:
  ...
  XPS project / EDK repository               : B:\SVN\CustomerProjects\Schleich\S-Analyzer\current\hdl\k-boot
  logical library name                       : axi_1wire_v1_00_a
  top name                                   : axi_1wire
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/axi_1wire_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/axi_1wire_v2_1_0.tcl
...
axi_lite_ipif_v1_01_a
	B:\SVN\CustomerProjects\Schleich\S-Analyzer\current\hdl\k-boot\C:\Xilinx\14.2\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\axi_lite_ipif_v1_01_a\doc\axi_lite_ipif_ds765.pdf
