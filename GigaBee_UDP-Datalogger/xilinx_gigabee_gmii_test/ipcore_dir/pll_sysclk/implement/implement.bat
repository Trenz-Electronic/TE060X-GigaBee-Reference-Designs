...
xst -ifn xst.scr
copy pll_sysclk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\pll_sysclk.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll_sysclk.ucf pll_sysclk_exdes

echo 'Running map'
map -timing -pr b pll_sysclk_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm pll_sysclk_exdes -w routed.ncd routed.vhd
cd ..
