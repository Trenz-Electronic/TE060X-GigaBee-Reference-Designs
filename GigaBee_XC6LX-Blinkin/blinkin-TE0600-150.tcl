# 
# Project automation script for blinkin-TE0600-150 
# 
# Created for ISE version 13.2
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source blinkin-TE0600-150.tcl), then you can
...
set myProject "blinkin-TE0600-150"
set myScript "blinkin-TE0600-150.tcl"
...
proc add_source_files {} {
   ...
   xfile add "src/TE0600.ucf"
   xfile add "src/blinkin.vhd"

   # Set the Top Module as well...
   project set top "Behavioral" "blinkin"
...
proc set_process_props {} {
   ...
   project set "Working Directory" "C:/Projects/Trenz/repos/TE060X-GigaBee-Reference-Designs/GigaBee_XC6LX-Blinkin"
   ...
   project set "Work Directory" "C:/Projects/Trenz/repos/TE060X-GigaBee-Reference-Designs/GigaBee_XC6LX-Blinkin/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "blinkin" -process "Generate IBIS Model"
